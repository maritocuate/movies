...
![](resources/dreadful-tomato-HOME.png)

TV shows page:

![](resources/dreadful-tomato-POPULAR-SERIES.png)

Movies page:

![](resources/dreadful-tomato-POPULAR-MOVIES.png)
...
* Inside directory `resources` you have all the icons and images to build the app
